...
<html lang="en">
       ...
       <div class="android-content mdl-layout__content">
        ...
        <div class="android-wear-section">
            ...
            <div class="android-wear-band-text mdl-shadow--4dp">
              <div class="mdl-typography--display-2 mdl-typography--font-thin">3. Edit the problem you want to solve.</div>
              	<p class="mdl-typography--font-light mdl-typography--subhead">
               		eople will love to support your Lokvishay if it’s clearifying your problem. Explain how this rise affect your, your family, or your community.
              </p>
              <!--Place where data Comes!-->
        <form action="../control/modifypatetion?id=3" method="post">
  				<textarea id="editor" name="body" required=""><?php
              ...
              <p class="mdl-typography--headline mdl-typography--font-thin ">
               	How to inspire your readers to act.
              </p>
  ...
  <li class="mdl-list__item mdl-list__item--three-line">
    <span class="mdl-list__item-primary-content">
      <span>Describe the solution</span>
      <span class="mdl-list__item-text-body">
...
<p>
            ...
            <i class="material-icons">chevron_right</i>
               ...
               <a class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored pull-right mdl-color--orange-400" id="skp" href="edit?id=4&&p_id=<?php echo $id; ?>" >
