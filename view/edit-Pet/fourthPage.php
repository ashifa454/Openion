...
<html lang="en">
  <head>
    ...
    <title>Media | Korridor India</title>
  ...
  <li class="mdl-list__item mdl-list__item--three-line">
    <span class="mdl-list__item-primary-content">
      <span>Choose a photo that captures the emotion of your petition</span>
...
<p>
  ...
  <div class="mdl-tooltip" for="show-btn">
    ...
    <div class="mdl-tooltip" for="donept" style="font-size:13px;">
    Save and go to my patetion.
  </div>
