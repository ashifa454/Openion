...
<html lang="en">
  <head>
    ...
    <title>Thankyou | Lokvishay</title>
  ...
  <body>
      ...
      <div class="android-content mdl-layout__content">
        ...
        <div class="android-wear-section">
            ...
            <div class="android-wear-band-text mdl-shadow--4dp">
              <div class="mdl-typography--display-2 mdl-typography--font-thin mdl-typography--text-center">Your Lokvishay is All Set.</div>
                <p class="mdl-typography--font-light mdl-typography--subhead">
                  Congratulation your vishay is Ready to Flow on Lokvishay Network, Once our representative will go through this vishay and will autorise it it will start showing on Lokvishay. 
              </p>
              <div class="mdl-cell mdl-cell--12-col mdl-cell--12-col-phone" style="border:dashed 2px #AAA4A4;">
    ...
    <form action="../control/start-Patetion/regPatetion?id=6" method="post">
               ...
               <a class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored pull-right mdl-color--orange-400" id="donept" type="submit" href="index">
  ...
  <li class="mdl-list__item mdl-list__item--three-line">
    <span class="mdl-list__item-primary-content">
      <span>Share your vishay via online medium</span>
      <span class="mdl-list__item-text-body">
       Click on share Button and copy the link of your vishay to share on any medium.
      </span>
    </span>
  ...
  <li class="mdl-list__item mdl-list__item--three-line">
    <span class="mdl-list__item-primary-content">
      <span>Discuss about your Lokvishay in Public or your Circle</span>
      <span class="mdl-list__item-text-body">
       Plan Debate or general Discussion on your Lokvishay to make people inform about your problem and ask them for support your army.
      </span>
    </span>
    </li>
  <li class="mdl-list__item mdl-list__item--three-line">
