...
<html lang="en">
  <head>
    ...
    <title>Add a media | Lokvishay</title>
      ...
      <div class="android-content mdl-layout__content">
        ...
        <div class="android-wear-section">
            ...
            <div class="android-wear-band-text mdl-shadow--4dp">
              <div class="mdl-typography--display-2 mdl-typography--font-thin">4. Add a Photo or Video.</div>
                <p class="mdl-typography--font-light mdl-typography--subhead">
                  vishay with a photo or video receive more signatures than those without. Include one that tells the whole story in one frame.
              </p>
              <div class="mdl-cell mdl-cell--12-col mdl-color--accen mdl-cell--12-col-phone" style="min-height:240px;border:dashed 2px #AAA4A4;" id="display">
...
<p>
            ...
            <i class="material-icons">looks_4</i>
               ...
               <a class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored pull-right mdl-color--orange-400" id="donept">
  ...
  <div class="mdl-tooltip" for="show-btn">
    Click here to add a Video to Your Petetion.
  </div>
    <div class="mdl-tooltip" for="picture">
    Click here to add a Picture to Your Petetion.
  </div>
    <div class="mdl-tooltip" for="donept">
    Save and Preview Your Petetion.
  </div>
    <form enctype="multipart/form-data">
    <input type="file" id="ptimg" style="display:none;" onchange="readURL(this);" /> 
    </form>
  </body>
