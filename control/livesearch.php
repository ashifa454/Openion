  ...
  for($i=0; $i<3; $i++) {
    ...
    if ($y->item(0)->nodeType==1) {
      ...
      if (stristr($y->item(0)->childNodes->item(0)->nodeValue,$q)) {
        if ($hint=="") {
          $hint="<a href='control/start-Patetion/regPatetion?id=4&&target=".$text1."&&post=".$text2."' style='text-decoration:none;'><li class='mdl-list__item mdl-list__item--two-line'>
          ...
          $hint=$hint."<a href='control/start-Patetion/regPatetion?id=4&&target=".$text1."&&post=".$text2."' style='text-decoration:none;'><li class='mdl-list__item mdl-list__item--two-line'>
